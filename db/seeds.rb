...
Institution.create(:name => "Mary Immaculate College Limerick ", :institution_category_id => InstitutionCategory.find_by_abbreviation("tlc").id, :abbreviation => "MIC")
Institution.create(:name => "St.Patrick College Drumcondra", :institution_category_id => InstitutionCategory.find_by_abbreviation("tlc").id, :abbreviation => "SPD")
Institution.create(:name => "Matter Dei Institute", :institution_category_id => InstitutionCategory.find_by_abbreviation("tlc").id, :abbreviation => "MDI")
Institution.create(:name => "Tipperary Institute of Technology", :institution_category_id => InstitutionCategory.find_by_abbreviation("iot").id, :abbreviation => "TIPPINST")


InstitutionPopulation.delete_all
InstitutionPopulation.create(:academic_year => 2011, :institution_id => Institution.find_by_abbreviation("UCD").id, :staff => 2568, :enrollments => 23655) 
InstitutionPopulation.create(:academic_year => 2011, :institution_id => Institution.find_by_abbreviation("UCC").id, :staff => 1823, :enrollments => 17122) 
InstitutionPopulation.create(:academic_year => 2011, :institution_id => Institution.find_by_abbreviation("NUIG").id, :staff => 1599, :enrollments => 16125) 
InstitutionPopulation.create(:academic_year => 2011, :institution_id => Institution.find_by_abbreviation("TCD").id, :staff => 1802, :enrollments => 16579) 
InstitutionPopulation.create(:academic_year => 2011, :institution_id => Institution.find_by_abbreviation("NUIM").id, :staff => 564, :enrollments => 7922) 
InstitutionPopulation.create(:academic_year => 2011, :institution_id => Institution.find_by_abbreviation("DCU").id, :staff => 911, :enrollments => 9995) 
InstitutionPopulation.create(:academic_year => 2011, :institution_id => Institution.find_by_abbreviation("UL").id, :staff => 1065, :enrollments => 11560) 
InstitutionPopulation.create(:academic_year => 2011, :institution_id => Institution.find_by_abbreviation("MIC").id, :staff => 267, :enrollments => 3014) 
InstitutionPopulation.create(:academic_year => 2011, :institution_id => Institution.find_by_abbreviation("SPD").id, :staff => 220, :enrollments => 2670)
InstitutionPopulation.create(:academic_year => 2011, :institution_id => Institution.find_by_abbreviation("MDI").id, :staff => 717, :enrollments => 43)
InstitutionPopulation.create(:academic_year => 2011, :institution_id => Institution.find_by_abbreviation("NCAD").id, :staff => 1174, :enrollments => 148)
InstitutionPopulation.create(:academic_year => 2011, :institution_id => Institution.find_by_abbreviation("RCSI").id, :staff => 0, :enrollments => 2896)
InstitutionPopulation.create(:academic_year => 2011, :institution_id => Institution.find_by_abbreviation("STACS").id, :staff => 110, :enrollments => 854)
InstitutionPopulation.create(:academic_year => 2011, :institution_id => Institution.find_by_abbreviation("AIT").id, :staff => 504, :enrollments => 4760)
InstitutionPopulation.create(:academic_year => 2011, :institution_id => Institution.find_by_abbreviation("CIT").id, :staff => 955, :enrollments => 9292)
InstitutionPopulation.create(:academic_year => 2011, :institution_id => Institution.find_by_abbreviation("DIT").id, :staff => 15454, :enrollments => 2051)
InstitutionPopulation.create(:academic_year => 2011, :institution_id => Institution.find_by_abbreviation("IADT").id, :staff => 206, :enrollments => 2182)
InstitutionPopulation.create(:academic_year => 2011, :institution_id => Institution.find_by_abbreviation("DKIT").id, :staff => 522, :enrollments => 4639)
InstitutionPopulation.create(:academic_year => 2011, :institution_id => Institution.find_by_abbreviation("GMIT").id, :staff => 669, :enrollments => 6686)
InstitutionPopulation.create(:academic_year => 2011, :institution_id => Institution.find_by_abbreviation("ITB").id, :staff => 218, :enrollments => 2102)
InstitutionPopulation.create(:academic_year => 2011, :institution_id => Institution.find_by_abbreviation("ITC").id, :staff => 358, :enrollments => 4282)
InstitutionPopulation.create(:academic_year => 2011, :institution_id => Institution.find_by_abbreviation("ITS").id, :staff => 470, :enrollments => 4919)
InstitutionPopulation.create(:academic_year => 2011, :institution_id => Institution.find_by_abbreviation("ITTALLAGHT").id, :staff => 356, :enrollments => 4029)
InstitutionPopulation.create(:academic_year => 2011, :institution_id => Institution.find_by_abbreviation("ITT").id, :staff => 343, :enrollments => 2650)
InstitutionPopulation.create(:academic_year => 2011, :institution_id => Institution.find_by_abbreviation("LYIT").id, :staff => 355, :enrollments => 3232)
InstitutionPopulation.create(:academic_year => 2011, :institution_id => Institution.find_by_abbreviation("LIT").id, :staff => 508, :enrollments => 4890)
InstitutionPopulation.create(:academic_year => 2011, :institution_id => Institution.find_by_abbreviation("TIPPINST").id, :staff => 0, :enrollments => 710)
InstitutionPopulation.create(:academic_year => 2011, :institution_id => Institution.find_by_abbreviation("WIT").id, :staff => 8402, :enrollments => 964)
